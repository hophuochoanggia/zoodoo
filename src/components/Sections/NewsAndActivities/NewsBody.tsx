...
const renderOptions = {
  renderNode: {
    [BLOCKS.HEADING_1]: (node: Block | Inline, children: ReactNode): ReactNode => {
      return <h1 className="text-2xl font-bold text-black">{children}</h1>;
    },
    [BLOCKS.HEADING_2]: (node: Block | Inline, children: ReactNode): ReactNode => {
      return <h2 className="text-xl font-bold text-black">{children}</h2>;
    },
    [BLOCKS.HEADING_3]: (node: Block | Inline, children: ReactNode): ReactNode => {
      return <h3 className="text-lg font-bold text-black">{children}</h3>;
    },
    [BLOCKS.HEADING_4]: (node: Block | Inline, children: ReactNode): ReactNode => {
      return <h4 className="text-md font-bold text-black">{children}</h4>;
    },
    [BLOCKS.HEADING_5]: (node: Block | Inline, children: ReactNode): ReactNode => {
      return <h5 className="text-sm font-bold text-black">{children}</h5>;
    },
    [BLOCKS.HEADING_6]: (node: Block | Inline, children: ReactNode): ReactNode => {
