...
const CheckInWithStatue = () => {
  return (
    <MainContainer background={BgImage4.src}>
      <div className="md:grid md:grid-cols-2 md:relative flex flex-col">
        <div>
          <SectionTitle
            icon={Icon7.src}
        ...
        <div className="md:absolute md:top-[-400px] md:right-0 pt-20 flex flex-row items-center justify-center">
