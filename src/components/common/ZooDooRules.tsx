...
const ZooDooRules = () => {
  return (
    <div
      className="bg-cover bg-no-repeat bg-center text-white py-16 lg:py-24 object-cover max-w-5xl flex flex-col items-center justify-center space-y-8"
      style={{
        backgroundImage: `url(${RulesBG.src})`,
      }}
    >
      <div className="grid grid-cols-6 px-20 gap-x-8">
        ...
        <div className="col-span-5 flex flex-col justify-center items-start ">
          <p className="text-[#374151] font-bold text-xl lg:text-2xl leading-9">
            Điều 1
          </p>
          <p className="text-[#374151] text-xl lg:text-2xl leading-9">
      ...
      <div className="grid grid-cols-6 px-20 gap-x-8 my-8">
        <div className="col-span-1">
          <Image
